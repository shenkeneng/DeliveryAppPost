...
package com.frxs.delivery.zxing.decoding;
...
import com.frxs.delivery.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler
{
	...
	public void handleMessage(Message message)
	{
		...
		case R.id.restart_preview:
			Log.d(TAG, "Got restart preview message state=" + state);
			restartPreviewAndDecode();
			break;
		case R.id.decode_succeeded:
			Log.d(TAG, "Got decode succeeded message state=" + state);
			state = State.SUCCESS;
		...
		case R.id.decode_failed:
			...
			// start another.
			Log.d(TAG, "Got decode_failed message state=" + state);
			state = State.PREVIEW;
